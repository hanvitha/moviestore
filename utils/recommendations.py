...
class Recommendation:
    ...
    def getTrendingRecommendations(self):
        # md = 155514
        # pd.read_csv('dataset/movies_metadata.csv')
        # query = "select * from movies;"
        ...
        qualified = self.md[(self.md['vote_count'] >= m) & (self.md['vote_count'].notnull()) & (self.md['vote_avg'].notnull())][['id', 'title','releasedate', 'vote_count', 'vote_avg']]
