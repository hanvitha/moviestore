...
CREATE TABLE `movie_genres` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=54407 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `movies` (
  ...
  `releasedate` varchar(14) DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `name` varchar(45) DEFAULT 'Blah',
  `email` varchar(45) DEFAULT 'blah@blah.com',
  `zipcode` varchar(7) DEFAULT '75666',
...
-- Dump completed on 2019-11-03 13:01:07
